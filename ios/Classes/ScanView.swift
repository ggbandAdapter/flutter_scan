...
public class ScanView:NSObject,FlutterPlatformView {
    ...
    public init(withFrame frame: CGRect, withRegistrar registrar: FlutterPluginRegistrar, withId id: Int64){
        ...
        channel = FlutterMethodChannel(name: "cn.ggband.ruilong/scanView_\(id)", binaryMessenger: registrar.messenger())
    }
